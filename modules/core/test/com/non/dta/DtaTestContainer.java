...
public class DtaTestContainer extends TestContainer {

    public DtaTestContainer() {
        super();
    ...
    public static class Common extends DtaTestContainer {

        public static final DtaTestContainer.Common INSTANCE = new DtaTestContainer.Common();
